...
export const services = [
	{
		...
		blurb:
			"Lorem ipsum dolor sit amet, a one-sentence summary of what this service includes.",
	...
	},
	{
		...
		blurb:
			"Consectetur adipiscing elit, describe the value and outcome a customer gets here.",
		points: ["Key feature one", "Key feature two", "Key feature three"],
	},
	{
		icon: "📦",
		...
		blurb:
			"Sed do eiusmod tempor, a thorough description of your premium or specialist offering.",
		points: ["Key feature one", "Key feature two", "Key feature three"],
	},
] as const;
...
export const whyUs = [
	{
		...
		blurb:
			"Lorem ipsum dolor sit amet — a benefit-led reason customers should choose you.",
	},
	{
		icon: "🌿",
		title: "Reason number two",
		blurb:
			"Consectetur adipiscing elit, another differentiator that sets you apart.",
	},
	{
		icon: "📅",
		title: "Reason number three",
		blurb:
			"Sed do eiusmod tempor incididunt, a reason that builds trust and convenience.",
	},
	{
		icon: "💚",
		title: "Reason number four",
		blurb:
			"Ut labore et dolore magna — your guarantee or promise to the customer.",
	},
] as const;
